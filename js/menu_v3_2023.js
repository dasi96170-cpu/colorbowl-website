        ...
        mainLink.removeClass('mob_main_link');
			...
			nav.find('li a').each(function() {
				if ($(this).next().length > 0) {
					$(this).parent('li').addClass('has-sub').append('<a class="dd-toggle" href="#"><span class="icon-plus"></span></a>').children('ul').hide();
				}
			});
...
$(document).ready(function(){
	$(".stellarnav > ul > li > ul").each(function(){
		let maxNum = $(this).children('li').length;
		if( maxNum > 15){
			$(this).parent("li").addClass('bigMenu').parents(".stellarnav").addClass("hasBigMenu")
		}
	})
})